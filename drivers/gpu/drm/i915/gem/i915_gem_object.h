...
int i915_gem_object_try_get_pages(struct drm_i915_gem_object *obj);
...
enum i915_mm_subclass { /* lockdep subclass for obj->mm.lock/struct_mutex */
	...
	I915_MM_GET_PAGES = 1,
	/*
	 * Used for obj->mm.lock when swapping in and out pages. Safe because
	 * obj->mm.lock is held recursively on different objects.
	 */
	I915_MM_EVICTION = 2,
};

static inline int __must_check
i915_gem_object_try_pin_pages(struct drm_i915_gem_object *obj)
{
	if (atomic_inc_not_zero(&obj->mm.pages_pin_count))
		return 0;

	return i915_gem_object_try_get_pages(obj);
}
...
int i915_gem_object_prepare_write(struct drm_i915_gem_object *obj,
				  unsigned int *needs_clflush);
int i915_gem_object_trylock_prepare_read(struct drm_i915_gem_object *obj,
				 unsigned int *needs_clflush);
int i915_gem_object_trylock_prepare_write(struct drm_i915_gem_object *obj,
				  unsigned int *needs_clflush);
...
int __must_check
i915_gem_object_try_set_to_wc_domain(struct drm_i915_gem_object *obj, bool write);
int __must_check
